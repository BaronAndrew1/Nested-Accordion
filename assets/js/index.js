...
arrow1.className="fa fa-arrow-down"
}

else {
  internalText1.textContent=""
  arrow1.className="fa fa-arrow-right grey"
}})
...
arrow2.className="fa fa-arrow-down"
}

else {
  internalText2.textContent=""
  arrow2.className="fa fa-arrow-right grey"
}})
...
arrow3.className="fa fa-arrow-down"
}

else {
  internalText3.textContent=""
  arrow3.className="fa fa-arrow-right grey"
}});
